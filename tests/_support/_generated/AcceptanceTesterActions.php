<?php  //[STAMP] 4ebc8f91b683a226251c75bdadb7b6fb
...
trait AcceptanceTesterActions
{
     ...
     *
     * Conditional Assertion: Test won't be stopped on fail
     * @see \Helper\Acceptance::seeInTitle()
     */
     ...
     * @see \Helper\Acceptance::localStorageClear()
     */
    public function localStorageClear($key = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('localStorageClear', func_get_args()));
    }
    ...
    *
     * Conditional Assertion: Test won't be stopped on fail
     * @see \Helper\Acceptance::seeImage()
     */
    public function canSeeImage($element, $minSizeXY = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\ConditionalAssertion('seeImage', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
    ...
    *
     * @see \Helper\Acceptance::seeImage()
     */
    public function seeImage($element, $minSizeXY = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\Assertion('seeImage', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\Acceptance::waitAndClick()
     */
